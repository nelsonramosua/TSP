...
#define SA_MULTIPLIER 25 // # iterations = SA_MULTIPLIER * numVertices

// Configuration for Ant Colony Optimization (ACO)
#define ACO_ALPHA 1.0 // pheromone influence
#define ACO_BETA 5.0  // heuristic influence (1/distance)
#define ACO_RHO 0.5   // pheromone evaporation rate
#define ACO_Q 100.0   // pheromone deposit factor
#define ACO_ITERATIONS 100 
#define ACO_MULTIPLIER 1.0 // # ants = ACO_MULTIPLIER * numVertices

// Configuration for Genetic Algorithm (GA)
#define GA_POPULATION_SIZE 100 // # individuals in the population (for each generation)
#define GA_NUM_GENERATIONS 10000 // # generations 
#define GA_MUTATION_RATE 0.02 // probability of mutation in individual (0 - 1)
#define GA_ELITISM_COUNT 2 // # top-performing individuals preserved for next gen
